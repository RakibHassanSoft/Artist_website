...
const Profile = () => {
    return (
        <section className="w-full overflow-hidden bg-gray-200 dark:bg-gray-900">
            <div className="flex flex-col">
                ...
                <div className="sm:w-[80%] xs:w-[90%] mx-auto flex">
                    <img src="https://images.unsplash.com/photo-1501196354995-cbb51c65aaea?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NzEyNjZ8MHwxfHNlYXJjaHw3fHxwZW9wbGV8ZW58MHwwfHx8MTcxMTExMTM4N3ww&ixlib=rb-4.0.3&q=80&w=1080" alt="User Profile"
                        className="rounded-md lg:w-[12rem] lg:h-[12rem] md:w-[10rem] md:h-[10rem] sm:w-[8rem] sm:h-[8rem] xs:w-[7rem] xs:h-[7rem] outline outline-2 outline-blue-500 relative lg:bottom-[5rem] sm:bottom-[4rem] xs:bottom-[3rem]" />
                    ...
                    <div
                        ...
                        <a href="https://www.linkedin.com/in/samuel-abera-6593a2209/">
                            <div className="p-2 hover:text-primary hover:dark:text-primary">
                                <svg className="lg:w-6 lg:h-6 xs:w-4 xs:h-4 text-gray-700" aria-hidden="true"
                        ...
                        <a href="">
                            <div className="p-2 hover:text-gray-700 hover:dark:text-gray-700">
                                <svg className="lg:w-6 lg:h-6 xs:w-4 xs:h-4 text-gray-700" aria-hidden="true"
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                                    viewBox="0 0 24 24">
                                    <path fillRule="evenodd"
